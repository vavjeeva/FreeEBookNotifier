...
internal class NotificationHelper(ctx: Context) : ContextWrapper(ctx) {
    ...
    init {
        ...
        val chan = NotificationChannel(PRIMARY_CHANNEL,getString(R.string.noti_channel_default), NotificationManager.IMPORTANCE_DEFAULT)
        chan.lightColor = Color.GREEN
        chan.lockscreenVisibility = Notification.VISIBILITY_PUBLIC
        manager.createNotificationChannel(chan)
    }

    fun getNotification(title: String, body: String, pendingIntent: PendingIntent): Notification.Builder {
